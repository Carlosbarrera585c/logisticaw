...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <p><h3>Confirmación de Vehículos</h3></p>
        </div> <!-- .content -->
            ...
            <form id="frmFletes" name="frmFletes" autocomplete="off" method="post" action="inc/logistica_fletes_insert.php">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        <label for="txtValorFlete">Valor Flete</label>
                         <input type="text" name="txtValorFlete" id="txtValorFlete" title="Valor Flete" onkeyup="format(this)" onchange="format(this)" placeholder="Valor Flete" required class="form-control">
                    </div>

                    <div class="col-lg-4 col-md-4 col-xs-12">
                    <label for="txtOpcion">Motivo Modificacion Flete</label>
                        <select name="txtOpcion" id="txtOpcion" required class="form-control">
                            <option>Excases de Vehiculos</option>
                            <option>Paro Camionero</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12" align="center">
                        <br>
                        <input type="submit" name="btnProcesar" class="btn btn-danger btn-large" value="Registrar Programación">
                    <div>
                </div>
