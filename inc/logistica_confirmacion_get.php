...
$sql = "SELECT        interAppCIL_ConfirmacionVehiculo.idConfirmacion, interAppCIL_ConfirmacionVehiculo.nit, interAppCIL_Transportadora.Transportadora, interAppCIL_ConfirmacionVehiculo.idTipoEnvio, interAppCIL_TipoEnvio.TipoEnvio, 
                         ...
                         interAppCIL_ConfirmacionVehiculo.idMotivoMod, interAppCIL_MotivosPrecio.Motivo, interAppCIL_ConfirmacionVehiculo.horaAprob_Aseguradora, interAppCIL_TipoVehiculo.TipoVehiculo
...
WHERE        interAppCIL_ConfirmacionVehiculo.idConfirmacion = ".$id;
